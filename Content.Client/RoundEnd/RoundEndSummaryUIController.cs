    ...
    IOnSystemLoaded<ClientGameTicker>
{
    ...
    public void OpenRoundEndSummaryWindow(RoundEndMessageEvent message)
    {
        ...
        _window = new RoundEndSummaryWindow(message.GamemodeTitle, message.RoundEndText,
            message.RoundDuration, message.RoundId, message.AllPlayersEndInfo, message.RoundEndStats, message.StatisticEntries, message.RoundEndKeyOutcomes, message.RoundEndSections, EntityManager, _playerManager); // Sunrise-Edit
    }
